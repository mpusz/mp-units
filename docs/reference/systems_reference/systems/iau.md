...
| <span id="newtonian_constant_of_gravitation"></span><code>newtonian_<wbr>constant_<wbr>of_<wbr>gravitation</code> | G | `G` | <code>mag_ratio<667'430, 100'000> * <wbr>mag_power<10, -11> * <wbr>cubic([si::metre](si.md#metre)) / <wbr>[si::kilogram](si.md#kilogram) / <wbr>square([si::second](si.md#second))</code> |
