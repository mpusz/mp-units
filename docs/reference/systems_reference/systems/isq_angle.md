...
| <span id="angular_impulse"></span><code>angular_<wbr>impulse</code> | Vector | L²Mα⁻¹T⁻¹ | <code>[angular_<wbr>impulse](#angular_impulse)</code> | — | <code>[moment_<wbr>of_<wbr>force](#moment_of_force) * <wbr>[isq::duration](isq.md#duration)</code> | [view](../hierarchies/angular_impulse_isq_angle.md) |
