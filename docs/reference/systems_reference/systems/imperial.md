...
**Header:** `<mp-units/systems/imperial.h>`
...
| <span id="drachm"></span><code>drachm</code> | dr | — | alias to [yard_<wbr>pound::dram](yard_pound.md#dram) |
...
| <span id="long_ton"></span><code>long_<wbr>ton</code> | t | — | alias to [ton](#ton) |
