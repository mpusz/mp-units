...
| <span id="illuminance"></span><code>illuminance</code> | Real | α²IL⁻² | ✓ | — | <code>[illuminance](#illuminance)</code> | — | <code>[luminous_<wbr>flux](#luminous_flux) / <wbr>pow<2>([length](#length))</code> | [view](../hierarchies/illuminance_hep.md) |
...
| <span id="luminous_flux"></span><code>luminous_<wbr>flux</code> | Real | α²I | ✓ | — | <code>[luminous_<wbr>flux](#luminous_flux)</code> | — | <code>[luminous_<wbr>intensity](#luminous_intensity) * <wbr>[solid_<wbr>angle](#solid_angle)</code> | [view](../hierarchies/luminous_flux_hep.md) |
