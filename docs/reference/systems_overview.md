...
| **International/Imperial**                                         |            |   ✓   | Traditional units used in the United Kingdom and other Commonwealth countries. Use when required by industry standards or regulations.                                              |            |
| **USC**                                                            |            |   ✓   | United States customary units. Use for aviation, construction, and other industries in the US.                                                                                      |            |
