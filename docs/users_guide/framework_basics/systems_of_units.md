...
```cpp
inline constexpr struct pi_c : mag_constant<symbol_text{u8"π", "pi"}, std::numbers::pi_v<long double>> {} pi_c;
inline constexpr struct pi : named_constant<symbol_text{u8"π", "pi"}, mag<pi_c> * one> {} pi;
