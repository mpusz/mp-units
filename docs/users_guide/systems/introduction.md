...
- **Automatic Unit Conversions**: Eliminate magic numbers, scaling factors, and conversion macros
  (no more multiplying by 3.6 or dividing by 1000—the library handles it correctly)
