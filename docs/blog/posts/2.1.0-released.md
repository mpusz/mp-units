...
More on this subject can be found in the [Converting to and from External Quantity
Types](../../how_to_guides/integration/converting_external_quantity_types.md)
chapter.
