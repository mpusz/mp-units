...
There are many more similar examples in the ISO/IEC 80000 series. For example,
...
Such interfaces are not much safer than just using plain fundamental types
